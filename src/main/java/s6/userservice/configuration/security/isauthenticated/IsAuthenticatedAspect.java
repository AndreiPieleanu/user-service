package s6.userservice.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(s6.userservice.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(s6.userservice.configuration.security.isauthenticated.IsAuthenticated)")
